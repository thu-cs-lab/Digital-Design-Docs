...
module timer(clock, reset, timer);
  ...
  wire _037_;
  (* force_downto = 32'd1 *)
  (* src = "examples/timer.v:17.22-17.38|/home/jiegec/prefix/yosys/bin/../share/yosys/techmap.v:270.23-270.24" *)
  wire [3:0] _038_;
  (* force_downto = 32'd1 *)
  (* src = "examples/timer.v:17.22-17.38|/home/jiegec/prefix/yosys/bin/../share/yosys/techmap.v:270.26-270.27" *)
  wire [3:0] _039_;
  (* force_downto = 32'd1 *)
  (* src = "examples/timer.v:20.24-20.43|/home/jiegec/prefix/yosys/bin/../share/yosys/techmap.v:270.23-270.24" *)
  wire [19:0] _040_;
  (* force_downto = 32'd1 *)
  (* src = "examples/timer.v:20.24-20.43|/home/jiegec/prefix/yosys/bin/../share/yosys/techmap.v:270.26-270.27" *)
  wire [19:0] _041_;
  ...
  assign _017_ = ~(counter_reg[7] | counter_reg[8]);
  assign _018_ = counter_reg[9] & _009_;
  assign _019_ = ~(counter_reg[10] | counter_reg[13]);
  assign _020_ = _018_ & _019_;
  assign _021_ = _017_ & _020_;
  assign _022_ = counter_reg[16] & counter_reg[18];
  assign _023_ = counter_reg[19] & _022_;
  assign _024_ = ~(counter_reg[12] | counter_reg[15]);
  assign _025_ = counter_reg[14] & counter_reg[17];
  ...
  assign _007_ = counter_reg[18] & _006_;
