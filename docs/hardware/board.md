...
6. SD 卡座：建议使用小容量低速 SD 卡，并通过 SPI 协议访问；按照标准，SD 卡都应该支持 SPI 协议，但有一些型号不支持，见 [1](https://forum.4dsystems.com.au/node/1869) 和 [2](https://github.com/MarlinFirmware/Marlin/issues/2082#issuecomment-102381964)；
