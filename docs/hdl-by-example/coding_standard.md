...
经过前面一些例子的学习，你应该已经学会了，如果从一个需求中，分析出所需要的波形，从而得到电路的实现，最后用 VHDL/Verilog 来实现。那么在编写代码的时候，你会发现所有的代码都是用比较类似的方式来编写的。因此在这里，我们总结了编写 VHDL/Verilog 的代码规范，在目前的学习阶段中，按照下面的代码规范进行代码编写，就可以规避大部分的错误。
